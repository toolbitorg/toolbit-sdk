...
sources = ['toolbit/toolbit_wrap.cxx','toolbit/tbi_core.cpp',
    ...
    'toolbit/tbit.cpp', 'toolbit/chopper.cpp', 'toolbit/choppy.cpp',
...
headers = ['toolbit/hidapi.h', 'toolbit/tbi_core.h',
    ...
    'toolbit/tbit.h', 'toolbit/chopper.h', 'toolbit/choppy.h',
...
setup (
    ...
    url = 'https://github.com/toolbitorg/toolbit-sdk',
    author ='ohamax',
    author_email = 'toolbitorg@gmail.com',
